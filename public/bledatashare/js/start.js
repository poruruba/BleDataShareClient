...
var vue_options = {
    ...
    methods: {
        do_file_paste: function(e){
            ...
            this.file_callback(e.dataTransfer.files);
        },
            ...
            for( let item of e.clipboardData.items){
                ...
                if( item.kind == 'string' ){
                    if( item.type == 'text/html' )
                        continue;
                    this.ble_write_type = "TEXT";
                    this.ble_write_text = await new Promise((resolve) =>{
                        item.getAsString(resolve);
                    });
                }else{
                    this.file_callback([item.getAsFile()]);
                    return;
                }
            }
        },
        ...
        do_ble_write_file: async function(){
