var mimetypesList = {
    ...
    'image/gif': 'gif',
    'image/ief': ['ief', 'iefs'],
    'image/jpeg': ['jpg', 'jpe', 'jpeg', 'jfif', 'jfif-tbnl'],
    'image/jutvision': 'jut',
    'image/ktx': 'ktx',
    ...
    'text/n3': 'n3',
    'text/pascal': 'pas',
    'text/plain': ['txt', 'bas', 'c', 'h', 'txt', 'c++', 'cc', 'com', 'conf', 'cxx', 'def', 'f', 'f90', 'for', 'g', 'hh', 'idc', 'jav', 'java', 'list', 'log', 'lst', 'm', 'mar', 'pl', 'sdml', 'text'],
    'text/plain-bas': 'par',
...
function findMimeExt(mime){
  var exts = mimetypesList[mime.toLowerCase()];
  if( exts == undefined )
    return "bin";
...
function findMimeType(ext){
  var exts = mimetypesExtensions[ext.toLowerCase()];
  if( exts == undefined )
